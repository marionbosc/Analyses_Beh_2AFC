...
switch WhichStep
    case 1
        ConfidenceSettings = ...
            ...
            'Max |bias|', 0.06, 'abs(0.5- (sum(SessionData.Custom.ChoiceLeft==1&SessionData.Custom.ChoiceCorrect==1)/sum(SessionData.Custom.ChoiceCorrect==1)))', ' <= ConfidenceSettings{Line, 2}';...
