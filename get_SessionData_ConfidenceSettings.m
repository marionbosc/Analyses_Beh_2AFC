...
switch WhichStep
    case 1
        ConfidenceSettings = ...
            ...
            'Min accuracy', 0.7, 'sum(SessionData.Custom.ChoiceCorrect==1)/SessionData.nTrials', ' >= ConfidenceSettings{Line, 2}';...
            ...
            'Min Max FB delay', 5, 'SessionData.Settings.GUI.FeedbackDelayMax', ' >= ConfidenceSettings{Line, 2}';...
            'Min FB delay Tau', 1, 'SessionData.Settings.GUI.FeedbackDelayTau', ' >= ConfidenceSettings{Line, 2}';...
