...
switch WhichStep
    case 1
        ConfidenceSettings = ...
            ...
            'Min accuracy', 0.69, 'sum(SessionData.Custom.ChoiceCorrect==1)/SessionData.nTrials', ' >= ConfidenceSettings{Line, 2}';...
            ...
            'Incorrect Choice feedback', 4, 'SessionData.Settings.GUI.IncorrectChoiceSignalType', ' == ConfidenceSettings{Line, 2}';...
            ...
            'Reward after Min sampling', 1, 'SessionData.Settings.GUI.RewardAfterMinSampling', ' == ConfidenceSettings{Line, 2}'};
