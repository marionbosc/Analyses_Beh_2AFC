...
%     clear def dlg_title numlines prompt Answers
    mintimeboundary = 0; maxtimeboundary = 120;
...
PerfperWT_fig(SessionDataWeek, 2,15, 0,2,2,3,SessionDataWeek.SessionDate,1,Modality);
% ShvsLgWT_fig(SessionData, Modality, NormorNot,nb_raw_fig,nb_col_fig,positn_fig,TitleExtra,Percentile,nbBin,BorneMaxWT)
ShvsLgWT_fig(SessionDataWeek, Modality, 0,2,2,4,'',70,8,15);
