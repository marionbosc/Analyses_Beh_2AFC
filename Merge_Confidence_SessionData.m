...
%    a) Prompt windows to get the Bpod protocol name 
%    b) Prompt windows to provide the animal's name
%    c) Prompt windows to select the localisation of data files
%    d) Prompt windows to decide whether the list of file to compile already
...
%    e) GUI with the list of critical criteria and their respective value to select the "good
