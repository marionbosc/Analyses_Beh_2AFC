...
FigurePath = [Pathtodata '/' AnimalName '/Analyses/Time_effect_' Filename_name(10:end-4)];

% Prompt windows to provide the maximum timepoint to include in the analysis
prompt = {'Maximum time in minutes = '}; dlg_title = 'Time window'; numlines = 1;
def = {'45'}; Uppertimelimit = str2double(inputdlg(prompt,dlg_title,numlines,def)); 
clear def dlg_title numlines prompt 

statornot = 0; colorornot = 1;
...
%% Skipped Correct FB
id_Interet_code = '~SessionData.Custom.Feedback & ~SessionData.Custom.CatchTrial&SessionData.Custom.ChoiceCorrect==1 & SessionData.Custom.TrialStartSec./60< Uppertimelimit';
id_Total_code = '~SessionData.Custom.CatchTrial & SessionData.Custom.ChoiceCorrect==1 & SessionData.Custom.TrialStartSec./60< Uppertimelimit';
type_variable = 'ratio';
bin_size = 100;
epoch = '';
Titre_parametre_analyse ='Skipped Correct Feedback (%)';
fig = plot_mean_Beh_param_acr_session (pathname, filename, id_Total_code, id_Interet_code,type_variable,epoch,Titre_parametre_analyse,statornot,colorornot,Uppertimelimit);
...
saveas(fig,[FigurePath '/SkippedCorrectFB.png']); close
 %% Correct trials
id_Interet_code = 'SessionData.Custom.ChoiceCorrect==1 & SessionData.Custom.TrialStartSec./60< Uppertimelimit';
id_Total_code = 'SessionData.Custom.ChoiceCorrect==0 & SessionData.Custom.TrialStartSec./60< Uppertimelimit | SessionData.Custom.ChoiceCorrect==1 & SessionData.Custom.TrialStartSec./60< Uppertimelimit';
bin_size = 100;
type_variable = 'ratio';
epoch = '';
...
%% EWD trials
id_Interet_code = 'SessionData.Custom.EarlyWithdrawal==1 & SessionData.Custom.TrialStartSec./60< Uppertimelimit';
id_Total_code = 'SessionData.Custom.FixBroke==0 & SessionData.Custom.TrialStartSec./60< Uppertimelimit';
bin_size = 100;
type_variable = 'ratio';
epoch = '';
...
%% WT Error trials
id_Interet_code = 'SessionData.Custom.ChoiceCorrect==0 & SessionData.Custom.TrialStartSec./60< Uppertimelimit';
id_Total_code = 'SessionData.Custom.ChoiceCorrect==0 & SessionData.Custom.TrialStartSec./60< Uppertimelimit | SessionData.Custom.ChoiceCorrect==1 & SessionData.Custom.TrialStartSec./60< Uppertimelimit';
bin_size = 100;
type_variable = 'duration';
epoch = 'FeedbackTime';
...
id_Interet_code = 'SessionData.Custom.ChoiceCorrect==1 & SessionData.Custom.CatchTrial & SessionData.Custom.TrialStartSec./60< Uppertimelimit';
id_Total_code = 'SessionData.Custom.ChoiceCorrect==0 & SessionData.Custom.TrialStartSec./60< Uppertimelimit | SessionData.Custom.ChoiceCorrect==1 & SessionData.Custom.TrialStartSec./60< Uppertimelimit';
bin_size = 100;
type_variable = 'duration';
epoch = 'FeedbackTime';
